...
**Measurments:**
- Top & long sides: 10 in × 4 in  
- Front & back: 8 in × 4 in  
...
<div style="display: flex; gap: 30px; align-items: flex-start;">
  ...
  <div>
    <p><strong>Time (min) Volume (mL)</strong></p>
    <p>0 &nbsp;&nbsp;&nbsp;&nbsp; 400</p>
    <p>2.5 &nbsp;&nbsp; 390</p>
    <p>5 &nbsp;&nbsp;&nbsp;&nbsp; 385</p>
    <p>7.5 &nbsp;&nbsp; 380</p>
    ...
    <p><strong>Flow Rate:</strong> ~3 mL/min</p>
  </div>
...
<div style="display: flex; gap: 30px; align-items: flex-start;">
  ...
  <div>
    ...
    <p><strong>Flow Rate:</strong> 90 mL/min</p>
  </div>
